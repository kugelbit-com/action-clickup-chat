...
module.exports = __nccwpck_require__(4031)(exports);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	module.exports = __nccwpck_require__(1040);
} else {
	module.exports = __nccwpck_require__(4194);
}
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(4116)("follow-redirects");
    }
    catch (error) { /* */ }
...
var debug = __nccwpck_require__(3364);
...
var populate = __nccwpck_require__(1117);
...
const axios_1 = __importDefault(__nccwpck_require__(8986));
async function run() {
    try {
...
const FormData$1 = __nccwpck_require__(8536);
...
const util = __nccwpck_require__(9023);
const followRedirects = __nccwpck_require__(1115);
 ...
 */
const main_1 = __nccwpck_require__(2525);
(0, main_1.run)().then();
